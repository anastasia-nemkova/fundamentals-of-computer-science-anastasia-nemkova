...
Написать простейшую программу на С, скомпилировать её с флагом -g, запустить отладчик gdb и проделать основные команды ( list, run, break, next, stop, setargs, showargs, setvar, backtrace и тд.) по отладке программы.
