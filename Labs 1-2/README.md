...
_ **Команды для справочной информации** _
...
_ **Команды для управления файлами и каталогами** _
...
| **сat**** \>**
**f1 f2 \> f3** | Показывает содержимое файлаПомещение текста с клавиатуры в файлОбъединение файлов f1, f2 в f3 |
| **rm** | Удаление файла |
...
_ **Команды для работы с** _ _ **Gnuplot** _
