...
3. Запротоколировать содержательное подмножество сеанса. Оформить отчет на бланке.
...
| --- | --- | --- | --- | --- | --- | --- |
|**1**|**Дом.** |**01.10.23** |**13:48** |**Проведение лабораторной работы по освоению удалённых команд OCUNIX**|**-** |**Все команды были проделаны без затруднений** |
