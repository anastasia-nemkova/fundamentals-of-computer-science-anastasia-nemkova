...
В ходе выполнения данной лабораторной работы были изучены основные этапы компиляции. Были приобретены навыки по созданию простейших программ на Си. Также было освоено, что необходимо делать для исправления кода программы при выдаче компилятором синтаксических ошибок и получении неверного результата.
