...
1. Переводим головку МТ в пустую ячейку справа от исходных аргументов;
2. Проделываем пункт 1 и 2 до окончания исходных аргументов
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Дом. | 01.10.23 | 14:24 | Изучение программирования машины Тьюринга | - | Все команды были проделаны без затруднений |
